...
# model settings
_C.MODEL = CN()
_C.MODEL.TYPE = 'VoxelNet'
_C.MODEL.NAME = 'VoxelNet'
_C.MODEL.RESUME = None
_C.MODEL.PRETRAINED = None
_C.MODEL.DETECT_OBJ = 'Car'
_C.MODEL.VFE_FILTER_NUM= [32, 128]
...
if _C.MODEL.DETECT_OBJ == 'Car':
    ...
    _C.VOXEL_X_SIZE = 0.2
    _C.VOXEL_Y_SIZE = 0.2
    _C.VOXEL_POINT_COUNT = 35
    _C.INPUT_WIDTH = int((_C.X_MAX - _C.X_MIN)/_C.VOXEL_X_SIZE)
    _C.INPUT_HIGHT = int((_C.Y_MAX - _C.Y_MIN)/_C.VOXEL_Y_SIZE)
    _C.FEATURE_RATIO = 2
